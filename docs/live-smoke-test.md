...
The default method is **QR**: scan the code from Telegram → Settings → Devices →
Link Desktop Device. The phone flow is the fallback tab if you have no second device.
